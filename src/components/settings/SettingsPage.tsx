...
function SettingsRow({ icon, iconBg, label, value, sub, onClick, danger, confirmLabel, confirming }: SettingsRowProps) {
  return (
    <button
      onClick={onClick}
      className={`w-full flex items-center gap-3 px-4 py-3.5 text-left border-b border-border last:border-0 transition-colors active:bg-terra-light/40 ${
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="px-5 pt-5 pb-4">
        <div className="bg-card rounded-2xl border-[1.5px] border-border p-4 flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl overflow-hidden flex-shrink-0 border-[1.5px] border-border">
            <img src="/logo-source.png" alt="MealMate" className="w-full h-full object-cover" />
          </div>
