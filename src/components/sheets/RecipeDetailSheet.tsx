      ...
      {recipe.photo ? (
        ...
        <div className="relative -mx-5 -mt-5 mb-0 px-5 pt-8 pb-5 rounded-t-[28px]" style={{ background: `linear-gradient(135deg, ${meta.bg}, ${meta.bg}80)` }}>
          <div className="flex items-start gap-4">
            {recipe.emoji
              ? <div className="w-[72px] h-[72px] rounded-[20px] bg-white/70 backdrop-blur flex items-center justify-center text-[36px] flex-shrink-0 shadow-sm border border-white/40">{recipe.emoji}</div>
